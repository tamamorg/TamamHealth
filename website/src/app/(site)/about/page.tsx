      ...
      <section id="crisis" style={{ background: "#0E2A4A", color: "#FFFFFF", padding: "74px 32px 86px" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
            ...
            <div className="blueprint tm-award" style={{ borderColor: "rgba(255,255,255,0.28)", display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "stretch", alignSelf: "start" }}>
              ...
              <div style={{ padding: "32px 28px", display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <span className="fs115" style={{ marginTop: "auto", paddingTop: 14, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(255,255,255,0.55)" }}>
                  Derby Entrepreneurship Center at Tufts · April 10, 2026
                </span>
              </div>
              <div className="tm-figure tm-minh280" style={{ position: "relative", minHeight: 280, borderLeft: "1px solid rgba(255,255,255,0.28)" }}>
                ...
                <img src="/assets/derby/derby-05.jpg" alt="Toye Adebayo, Teny Makuach and Ekow Williams holding the $10,000 check at the Derby Entrepreneurship Center at Tufts" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
          </div>
          ...
          <div style={{ marginTop: 64, borderTop: "1px solid rgba(255,255,255,0.28)", paddingTop: 26 }}>
            ...
            <div className="tm-gallery" tabIndex={0} role="group" aria-label="Photos from the Tufts New Ventures Competition, April 10, 2026">
