...
function Check() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#7FC4EA" strokeWidth="1.5" strokeLinecap="square" style={{ flexShrink: 0, marginTop: 2 }} aria-hidden="true">
...
export default function ContactPage() {
  return (
    <main>
      ...
      <section id="contact" style={{ background: "#0E2A4A", color: "#FFFFFF", padding: "76px 32px 84px" }}>
        <div className="tm-contact-hero" style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: 72, alignItems: "start" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 30, paddingTop: 12 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 8, paddingTop: 22, borderTop: "1px solid rgba(255,255,255,0.22)" }}>
              <span style={{ fontSize: 11.5, letterSpacing: "0.16em", textTransform: "uppercase", color: "#7FC4EA" }}>Who answers</span>
              <p style={{ margin: 0, maxWidth: 540, fontSize: 15.5, lineHeight: 1.6, color: "rgba(255,255,255,0.78)" }}>
                The founding team, within two working days. If you would rather see it before you write, ask for a demo and we will
                walk a full patient day end to end.
              </p>
            </div>
          </div>
