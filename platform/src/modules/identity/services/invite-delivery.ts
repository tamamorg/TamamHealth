...
import { logApiError } from '@/modules/identity/core/api-auth';
...
export async function deliverAccountInvite(
  ...
  try {
    const [
      ...
      import('@/modules/identity/provisioning/user-invite'),
      import('@/modules/identity/email/user-welcome'),
      import('@/modules/identity/email/password-reset'),
      import('@/lib/role-display'),
      import('@/lib/email'),
    ]);
