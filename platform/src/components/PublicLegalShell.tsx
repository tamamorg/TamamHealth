...
.lg-meta dd { margin: 0; color: var(--text-secondary, #334155); font-weight: 600; align-self: center; }
...
.lg-toc__num { color: var(--text-muted, #64748B); font-variant-numeric: tabular-nums; }
...
.lg-body strong { color: var(--text-primary, #0F172A); font-weight: 700; }
