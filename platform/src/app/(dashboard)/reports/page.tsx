...
/* The catalogue, its translation lookups and the filter that narrows it now
   live in ./_ReportCatalogue — the rail grew filters and this file was already
   1,169 lines. */
...
export default function ReportsPage() {
  ...
  const chartableReports = allReports;

  /* The rail's filter. Page state, not rail state: the rail is a controlled
     view of it, and the page needs to know whether a filter is on to answer
     "why is the picked report not in the list?". */
