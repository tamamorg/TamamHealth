 ...
 * lanes the mobile shell shows: Waiting (booked, patient not yet with us),
 * In service (visit open at the facility), Finished (the slot is closed —
