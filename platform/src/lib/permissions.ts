...
export const ROLE_PERMISSIONS: Record<UserRole, RoleConfig> = {
  super_admin: {
    ...
    navItems: [
      ...
      { href: '/manage', label: 'Organizations', icon: Building2, section: 'TENANTS' },
  ...
  lab_tech: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'LABORATORY' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  pharmacist: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'PHARMACY' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  front_desk: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'RECEPTION' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  cashier: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'CASHIER' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  government: {
    ...
    navItems: [
      ...
      { href: '/manage', label: 'Organizations', icon: HospitalIcon, section: 'HEALTH SYSTEM PERFORMANCE' },
  ...
  county_health_director: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare },
      { href: '/manage', label: 'Facilities', icon: HospitalIcon, section: 'OVERSIGHT' },
  ...
  medical_superintendent: {
    ...
    navItems: [
      // Sections must be CONTIGUOUS: `groupNavItemsBySection` groups by run, so
      ...
      // <ItOperationsPanel /> itself (System administration → IT Operations),
  ...
  hrio: {
    ...
    navItems: [
      ...
      { href: '/manage', label: 'Facilities', icon: Building2, section: 'GOVERNANCE' },
      { href: '/dhis2-export', label: 'DHIS2 Export', icon: Download, section: 'GOVERNANCE' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
  ...
  nutritionist: {
    ...
    navItems: [
      ...
      { href: '/mch-analytics', label: 'MCH Analytics', icon: HeartPulse, section: 'NUTRITION' },
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'NUTRITION' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  radiologist: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'IMAGING' },
    ],
    color: BRAND_PRIMARY,
    gradientFrom: BRAND_SECONDARY,
    gradientTo: BRAND_PRIMARY,
  ...
  hospital_manager: {
    ...
    navItems: [
      ...
      { href: '/hr/payroll', label: 'Payroll', icon: Wallet, section: 'PEOPLE & HR' },
      { href: '/inquiries', label: 'Patient Inquiries', icon: MessageSquare, section: 'PEOPLE & HR' },
      { href: '/payments', label: 'Revenue & Bills', icon: Wallet, section: 'REPORTING' },
      { href: '/reports', label: 'Reports', icon: BarChart3, section: 'REPORTING' },
      { href: '/data-quality', label: 'Data Quality', icon: Database, section: 'REPORTING' },
      { href: '/vital-statistics', label: 'Vital Statistics', icon: TrendingUp, section: 'REPORTING' },
  ...
  central_registration_clerk: {
    ...
    navItems: [
      ...
      { href: '/appointments', label: 'Appointments', icon: Calendar, section: 'RECEPTION' },
      { href: '/referrals', label: 'Referrals', icon: ArrowRightLeft, section: 'RECEPTION' },
      { href: '/payments', label: 'Checkout Payments', icon: Wallet, section: 'RECEPTION' },
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'RECEPTION' },
    ],
  ...
  clinic_clerk: {
    ...
    navItems: [
      ...
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'CLINIC' },
    ],
  ...
  records_hmis_officer: {
    ...
    navItems: [
      ...
      { href: '/data-quality', label: 'Data Quality', icon: Database, section: 'RECORDS' },
      { href: '/reports', label: 'Reports', icon: BarChart3, section: 'RECORDS' },
      // GOVERNANCE was split by a lone 'VITAL EVENTS' row and rendered twice.
      ...
      { href: '/dhis2-export', label: 'DHIS2 Export', icon: Download, section: 'GOVERNANCE' },
      { href: '/facility-assessments', label: 'Facility Assessments', icon: ClipboardCheck, section: 'GOVERNANCE' },
      { href: '/manage', label: 'Facilities', icon: HospitalIcon, section: 'GOVERNANCE' },
    ],
