...
export const ROLE_PERMISSIONS: Record<UserRole, RoleConfig> = {
  super_admin: {
    ...
    navItems: [
      ...
      { href: '/admin/account-requests', label: 'Account Requests', icon: ClipboardCheck, section: 'TENANTS' },
  ...
  org_admin: {
    ...
    navItems: [
      ...
      { href: '/org-admin/account-requests', label: 'Account Requests', icon: ClipboardCheck, section: 'PEOPLE & ACCESS' },
