...
export function createDBMock() {
  return {
    ...
    conversationsDB: () => getTestDB('test_tamamhealth_conversations'),
    ...
    paymentPlansDB: () => getTestDB('test_tamamhealth_payment_plans'),
    availabilityDB: () => getTestDB('test_tamamhealth_availability'),
    handoffsDB: () => getTestDB('test_tamamhealth_handoffs'),
    assetsDB: () => getTestDB('test_tamamhealth_assets'),
    leaveRequestsDB: () => getTestDB('test_tamamhealth_leave_requests'),
    payrollEntriesDB: () => getTestDB('test_tamamhealth_payroll_entries'),
    orderSetsDB: () => getTestDB('test_tamamhealth_order_sets'),
    bookingPoliciesDB: () => getTestDB('test_tamamhealth_booking_policies'),
    visitReasonsDB: () => getTestDB('test_tamamhealth_visit_reasons'),
    providerProfilesDB: () => getTestDB('test_tamamhealth_provider_profiles'),
    SEED_VERSION: 12,
